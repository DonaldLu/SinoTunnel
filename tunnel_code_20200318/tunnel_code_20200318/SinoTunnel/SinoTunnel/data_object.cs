...
namespace DataObject
{
    ...
    {
        public List<string[]> inverted_arc_station = new List<string[]>();
        public List<string[]> track_bed_station = new List<string[]>();
        public List<string[]> gutter_station = new List<string[]>();
        public List<string[]> walk_way_station = new List<string[]>();
        public List<string[]> third_rail_station = new List<string[]>();
    }
